...
def storeSpotDataInSession(request: HttpRequest, spotifyResJSON: json):
  ...
  request.session['access_token'] = spotifyResJSON['access_token']
  request.session['token_type'] = spotifyResJSON['token_type']
  request.session['scope'] = spotifyResJSON['scope']
  ...
  request.session['refresh_token'] = spotifyResJSON['refresh_token']
  # Return True
  return True
