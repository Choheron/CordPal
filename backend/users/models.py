...
class UserAction(models.Model):
  ...
  entity_type = models.CharField(max_length=50)  # "ALBUM", "ALBUM_COMMENT", "ALBUM_OWNER", "ALBUM_SELECTION_OUTAGE", "ALBUM_TAG", "ALBUM_TAG_VOTE", "CUSTOM_EMOJI", "GLOBAL_TAG", "QUOTE", "REACTION", "REVIEW"
