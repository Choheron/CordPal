      ...
      <Conditional showWhen={aotd_participant}>
        <div className="w-full xl:w-4/5 4xl:w-4/6">
          <div className="flex flex-col w-full justify-center 2xl:flex-row">
            ...
            <div className="w-full 2xl:w-[20%] flex flex-col xl:flex-row 2xl:flex-col 2xl:pl-2">
              {/* Display the album from a year ago today if it exists */}
              <div className="w-full xl:w-1/2 2xl:w-full">
                ...
                >
                  <Button
                    className="w-full p-2 mx-auto my-2 text-sm text-inheret h-fit bg-gradient-to-br from-green-700/80 to-green-800/80 hover:underline"
                    size="sm"
                    radius="lg"
                    variant="solid"
                  >
              ...
              <div className={`mb-2 w-full xl:w-1/2 2xl:w-full xl:pl-2 2xl:pl-0 2xl:flex-1 2xl:min-h-[220px] 2xl:relative`}>
