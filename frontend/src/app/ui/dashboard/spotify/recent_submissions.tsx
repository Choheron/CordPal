...
export default async function RecentSubmissions(props) {
  ...
  return (
    <div className="h-full min-w-[320px] w-full lg:w-[340px] mx-auto lg:mx-1 lg:mt-2 lg:mb-1 flex flex-col backdrop-blur-2xl rounded-2xl bg-zinc-800/30 border border-neutral-800">
        ...
        {recentSubs.length === 0 ? (
            ...
            recentSubs.map((submission, index) => (
              <div className="ml-1" key={index}>
                <Button 
                  as={Link}
                  href={"/dashboard/aotd/album/" + submission['spotify_id']}
                  radius="lg"
