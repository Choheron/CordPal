...
export default async function RecentSubmissions(props) {
  ...
  return (
    <div className="h-full min-w-[320px] w-full lg:w-[340px] mx-auto lg:mx-1 lg:my-2 flex flex-col backdrop-blur-2xl rounded-2xl bg-zinc-800/30 border border-neutral-800">
