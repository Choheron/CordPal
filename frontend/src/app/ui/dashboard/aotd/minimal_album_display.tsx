...
export default async function MinimalAlbumDisplay(props: any) {
  ...
  const album_cover_src = (props.album_img_src) ? props.album_img_src : "/images/album-not-found.png";
  ...
  const starTextOverride = (props.starTextOverride) ? props.starTextOverride : 'text-xl'
