...
export default async function CordpalPlaybackBanner(props) {
  ...
  return (
    <div className="hidden md:block fixed top-2 right-2">
      ...
      <Conditional showWhen={isJan && globalPlaybackAvailable}>
        ...
        >
          <div className={`z-10 p-5 relative flex align-middle items-center snap-start bg-gradient-to-bl from-violet-600 to-purple-900 rounded-2xl ${bartle.className}`}>
